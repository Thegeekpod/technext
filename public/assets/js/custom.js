...
//iframe
!function(d,s,id)
{var js,fjs=d.getElementsByTagName[0],p=/^http:/.test(d.location)?'http':'https';
if(!d.getElementById(id)){js=d.createElement;js.id=id;js.src=p+"://platform.twitter.com/widgets.js";
